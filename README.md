...
- Question Answer Dataset [Notebook](Q&A_Implementation_using_Seq2Seq_and_attention.ipynb) : Train Accuracy = 90% (9/10 Questions answered correctly)
- Quora Dataset [Notebook](Quora-similarity.ipynb) : Train Accuracy = 
